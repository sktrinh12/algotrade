...
from strategies.AroonCrossover import AroonCrossoverCalc


class TestAroonCrossover(unittest.TestCase):
    SYMBOL = 'AAPL'
    def setUp(self):
        self.cash = 1000000
...
if __name__ == '__main__':
    TestAroonCrossover.SYMBOL = os.environ.get('SYMBOL', TestAroonCrossover.SYMBOL)
    unittest.main()
